...
void _laKeyPadWidget_Constructor(laKeyPadWidget* pad, uint32_t rows, uint32_t cols)
{
	...
	pad->widget.drawBackground = LA_FALSE;
...
void laKeyPadWidget_GetKeyText(laKeyPadWidget* pad,
                               uint32_t row,
                               uint32_t col,
                               laString* str)
{
...
void laKeyPadWidget_SetKeyText(laKeyPadWidget* pad,
                               uint32_t row,
                               uint32_t col,
                               laString str)
{
                                           ...
                                           uint32_t col)
{
    ...
    return laWidget_GetDrawBackground((laWidget*)_getButton(pad, row, col));
}
                                                    ...
                                                    laBool draw)
{
    ...
    laWidget_SetDrawBackground((laWidget*)_getButton(pad, row, col), draw);
}
...
void laKeyPadWidget_SetKeyValue(laKeyPadWidget* pad,
                                uint32_t row,
                                uint32_t col,
                                laString str)
{
