...
typedef struct laContext_t
{
	...
	laList screenList; // the list of the screens in the context
...
/* Function:
   ...
   Summary:
    Set the pre-emption level to the specified value  
...
*/
LIB_EXPORT laResult laContext_SetPremptionLevel(laPreemptionLevel level);
