...
// *****************************************************************************
/* Function:
    GFX_Color GFX_ColorSetAlpha(GFX_Color color, GFX_ColorMode mode, uint32_t alpha)

  Summary:
    Attempts to set the alpha channel of a color to a value

  Parameters:
	GFX_Color - the source color
	GFX_ColorMode - the source color mode
	uint32_t - the desired alpha value
...
*/									  
LIB_EXPORT GFX_Color GFX_ColorSetAlpha(GFX_Color color, GFX_ColorMode mode, uint32_t alpha);
...
/* Function:
  ...
  Summary:
    Blends two colors together using either their alpha channel or, in the case of
    a mode with no alpha channel, the specified alpha value.
  ...
  Parameters:
	...
	GFX_ColorMode - the color mode of the input colors
	uint32_t - the alpha blend amount
...
*/	
LIB_EXPORT GFX_Color GFX_ColorBlendAlpha(GFX_Color fore,
										 GFX_Color back,
										 GFX_ColorMode mode,
										 uint32_t alpha);
