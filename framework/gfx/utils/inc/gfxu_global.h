...
// *****************************************************************************
/* typedef:
    GFXU_MemoryReadRequestCallback_FnPtr

  Summary:
    A callback that signifies that a memory read request has been fulfilled.
...
*/                                                 
typedef GFX_Result (*GFXU_MemoryReadRequest_FnPtr)(GFXU_ExternalAssetReader* reader, // asset reader
                                                   uint32_t,  // location ID
                                                   void*,     // address
                                                   uint32_t,  // dest size
                                                   uint8_t*,  // dest buffer
                                                   GFXU_MemoryReadRequestCallback_FnPtr); // callback
...
typedef enum GFXU_AssetType_t
{
    ...
    GFXU_ASSET_TYPE_PALETTE = 0,
    GFXU_ASSET_TYPE_FONT = 0,
    GFXU_ASSET_TYPE_BINARY = 0,
    GFXU_ASSET_TYPE_STRINGTABLE = 0
} GFXU_AssetType;
