...
static _TCPIP_PKT_FLAG_TYPE _TCPIP_PKT_ModFlags[] = 
{
    ...
    TCPIP_PKT_FLIGHT_FLAG_LOG,              // TCPIP_MODULE_IGMP,
	...
	0,                                      // TCPIP_MODULE_TFTP_CLIENT,
	0,                                      // TCPIP_MODULE_DHCPV6_CLIENT,
	0,                                      // TCPIP_MODULE_SMTPC,
...
static const uint8_t _TCPIP_PKT_ModName[][6] __attribute__((aligned(4)))= 
{
	...
	"TFTC:\0",             // TCPIP_MODULE_TFTP_CLIENT,
	"DHC6:\0",             // TCPIP_MODULE_DHCPV6_CLIENT,
	"SMTC:\0",             // TCPIP_MODULE_SMTPC,
};

// table with packet names based on the module type 
