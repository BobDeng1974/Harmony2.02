...
#define TCPIP_DHCP_DEBUG_MASK_FAKE_TMO          0x40    // enable fake timeout support...
#define TCPIP_DHCP_DEBUG_MASK_LEASE_DECLINE     0x80    // enable fake lease decline
#define TCPIP_DHCP_DEBUG_MASK_FAIL_ARP          0x100   // enable ARP failures 
#define TCPIP_DHCP_DEBUG_MASK_FAKE_LEASE_TIME   0x200   // fake the lease time 
#define TCPIP_DHCP_DEBUG_MASK_FAKE_HOST_NAME    0x400   // fake the host name 
