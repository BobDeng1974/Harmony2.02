...
config DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE}
    ...
    depends on USE_DRV_I2C
    range DRV_TMR_INDEX	
    default "DRV_TMR_INDEX_1" if DRV_TMR_INSTANCES_NUMBER = 1
    default "DRV_TMR_INDEX_2" if DRV_TMR_INSTANCES_NUMBER = 2
    default "DRV_TMR_INDEX_3" if DRV_TMR_INSTANCES_NUMBER = 3
    default "DRV_TMR_INDEX_4" if DRV_TMR_INSTANCES_NUMBER = 4
    default "DRV_TMR_INDEX_5" if DRV_TMR_INSTANCES_NUMBER = 5
    default "DRV_TMR_INDEX_6" if DRV_TMR_INSTANCES_NUMBER = 6
    default "DRV_TMR_INDEX_7" if DRV_TMR_INSTANCES_NUMBER = 7
    default "DRV_TMR_INDEX_8" if DRV_TMR_INSTANCES_NUMBER = 8
    default "DRV_TMR_INDEX_9" if DRV_TMR_INSTANCES_NUMBER = 9
