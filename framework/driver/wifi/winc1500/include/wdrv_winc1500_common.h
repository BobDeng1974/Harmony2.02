/*************************************************************************
  ...
  Summary:
    WINC1500 Driver Common Header File
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 scan context data.
*/
typedef struct
{
    ...
    /************************************************************************
      The minimum time (in milliseconds) the WINC1500 will wait for a probe
      response after sending a probe request. If no probe responses are
      received in minChannelTime, the WINC1500 will go on to the next channel,
      if any are left to scan, or quit. Default is 200ms.
      ************************************************************************/
    uint16_t minChannelTime;

    /************************************************************************
      If a probe response is received within minChannelTime, the WINC1500 will
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 WEP context.
*/
typedef struct
{
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 WPA key info. This structure is used in
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 WPA context.
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 WPS security context.
*/
typedef struct
{
...
/*******************************************************************************
  ...
  Description:
    ...
    This structure contains WINC1500 security context.
*/
typedef union
{
...
typedef struct {
    WDRV_INDICATIONS ind;
    TCPIP_MAC_PACKET *(*get_rx_buf)(void);
