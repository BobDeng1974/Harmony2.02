...
static IWPRIV_CONN_STATUS _connstatus_get(void)
{
	...
	conn_status = WDRV_ConnectionStatus_Get();
	switch (conn_status) {
...
void iwpriv_get(IWPRIV_CMD cmd, IWPRIV_GET_PARAM *param)
{
    ...
    case CONNSTATUS_GET:
        ...
        break;
    case DEVICEINFO_GET:
        ((WDRV_DEVICE_INFO *)param->devInfo.data)->deviceType = WDRV_WINC15000M_DEVICE;
        break;
    case DRVSTATUS_GET:
        param->driverStatus.isOpen = _drvstatus_get();
        break;
    case FWUPGRADEREQUEST_GET:
        param->fwUpgrade.requested = g_wdrv_priv.isFwUpgradeRequested;
        break;
