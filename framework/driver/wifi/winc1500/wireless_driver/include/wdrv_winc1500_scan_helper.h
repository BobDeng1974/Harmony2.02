/*******************************************************************************
  WINC1500 Wi-Fi Driver Scan Helper Implementation

  File Name:
    wdrv_winc1500_scan_helper.h

  Summary:
    WINC1500 Wi-Fi Driver Scan Helper Implementation

  Description:
    -Provides access to WINC1500 WiFi controller
    -Reference: WINC1500 Datasheet, IEEE 802.11 Standard
 *******************************************************************************/
...
#ifndef _WDRV_WINC1500_SCAN_HELPER_H
#define _WDRV_WINC1500_SCAN_HELPER_H
...
#endif /* _WDRV_WINC1500_SCAN_HELPER_H */
