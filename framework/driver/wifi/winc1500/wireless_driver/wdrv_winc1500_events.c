/*******************************************************************************
  TCP/IP WINC1500 MAC Events Implementation
...
static WDRV_WINC1500_EVGROUP_DCPT s_mrfGroupDcpt = 
{
    TCPIP_MAC_EV_NONE, TCPIP_MAC_EV_NONE, 0
};
static WDRV_WINC1500_USREV_DCPT s_mrfUsrEvent; // stack user events
