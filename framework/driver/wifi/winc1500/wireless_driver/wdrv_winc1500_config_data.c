/*******************************************************************************
  WINC1500 Configuration Data

  File Name:
    wdrv_winc1500_config_data.c
...
static void SaveConfigToMemory(void)
{
    ...
    if (WDRV_NVM_PageEraseConfigWrite((uint8_t *)p_wdrv_configData, sizeof(WDRV_CONFIG_DATA), WDRV_NVM_SPACE_ADDR))
        SYS_CONSOLE_MESSAGE("WINC1500: NVM operation succeeded\r\n");
    else
        SYS_CONSOLE_MESSAGE("WINC1500: NVM operation failed\r\n");
}
...
static void SaveConfigToMemory(void)
{
    ...
    SYS_CONSOLE_MESSAGE("WINC1500: Save operation succeeded\r\n");
}

static void DeleteConfigInMemory(void)
{
    memset(&s_wdrv_configDataBackup, 0, sizeof(WDRV_CONFIG_DATA));
    SYS_CONSOLE_MESSAGE("WINC1500: Erase operation succeeded\r\n");
}
