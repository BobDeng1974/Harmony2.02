...
/*
  Function:
    void DRV_AK4384_SetAudioCommunicationMode(const DRV_HANDLE handle, 
  ...
  Example:
    ...
    uint8_t mybuffer[MY_BUFFER_SIZE];
    DRV_AK4384_BUFFER_HANDLE bufferHandle;
    SPI_AUDIO_COMMUNICATION_WIDTH audioCommWidth = APP_INIT_AUDIO_COMMUNICATON_WIDTH;
    ...
    DRV_AK4384_SetAudioCommunicationMode(myAK4384Handle, audioCommWidth);
