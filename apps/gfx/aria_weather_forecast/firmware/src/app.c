...
GFX_Result memoryRead_Callback(GFXU_ExternalAssetReader* reader,
                               uint32_t locationID,
                               void* readAddress,
                               uint32_t readSize,
                               uint8_t* writeBuffer,
                               GFXU_MemoryReadRequestCallback_FnPtr finishedCallback)
{
    return GFX_SUCCESS;
}

GFXU_ExternalAssetReader* assetReaderTask;
