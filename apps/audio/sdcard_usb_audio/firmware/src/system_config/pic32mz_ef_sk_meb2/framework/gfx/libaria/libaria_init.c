...
static void ScreenCreate_MchpName(laScreen* screen)
{
    ...
    laWidget_SetDrawBackground((laWidget*)GradientWidget1, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)DemoName, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)RadioButtonSd, LA_TRUE);
    ...
    laRadioButtonWidget_SetSelectedEventCallback(RadioButtonSd, &RadioButtonSd_CheckedEvent);
    ...
    laWidget_SetDrawBackground((laWidget*)RadioButtonUSB, LA_TRUE);
    ...
    laRadioButtonWidget_SetSelectedEventCallback(RadioButtonUSB, &RadioButtonUSB_CheckedEvent);
    ...
    laWidget_SetDrawBackground((laWidget*)TrackListBox, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)MuteButton, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)MicrochipLogo, LA_FALSE);
    ...
    laWidget_SetDrawBackground((laWidget*)VolumeDownButton, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)VolumeUpButton, LA_TRUE);
    ...
    laWidget_SetDrawBackground((laWidget*)VolumeBar, LA_TRUE);
