...
#ifndef _RTDM_UART_H    /* Guard against multiple inclusion */
#define _RTDM_UART_H 
...
#define UxMODE_VALUE            0x00000000
#define UxSTA_VALUE             0x00000110
#define UxTXREG_VALUE           0x00000000
#define UxRXREG_VALUE           0x00000000
#define UxBRG_VALUE             0x00000000
...
#define UART_INT_TX_BUF_EMPTY   0xBFFF  /* Interrupt on TXBUF becoming empty */
#define UART_INT_TX_LAST_CH     0x7FFF  /* Interrupt when last character shifted out*/
#define UART_INT_TX             0x3FFF  /* Interrupt on transfer of every character to TSR */

#define UART_IrDA_POL_INV_ONE   0xFFFF  /*IrDA encoded, UxTX Idle state is '1' */
#define UART_IrDA_POL_INV_ZERO  0xDFFF  /* IrDA encoded, UxTX Idel state is '0' */
