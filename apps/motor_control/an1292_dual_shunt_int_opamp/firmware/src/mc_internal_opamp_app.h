...
#ifndef _MC_INTERNAL_OPAMP_APP_H
#define _MC_INTERNAL_OPAMP_APP_H
...
typedef enum
{
	...
	MC_INTERNAL_OPAMP_APP_CLASSB_STATE_INIT=0,
	MC_INTERNAL_OPAMP_APP_CLASSB_STATE_FLASH_CRC_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_CHECKER_BOARD_RAM_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_RAM_MARCHB_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_RAM_MARCHC_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_RAM_MARCHC_STACK_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_CLOCK_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_CPU_PC_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_CPU_REGISTERS_TEST,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_TEST_PASS,
    MC_INTERNAL_OPAMP_APP_CLASSB_STATE_TEST_FAIL,
} MC_INTERNAL_OPAMP_APP_CLASSB_STATES;
...
union  SYSTEM_STATUS_UNION 
{
	...
	unsigned short Word;
}MC_INTERNAL_OPAMP_APP_MC_CONTROL ;        						// general flags
...
{
	/* Application's state machine's initial state. */
	MC_INTERNAL_OPAMP_APP_MC_STATE_INIT=0,
	MC_INTERNAL_OPAMP_APP_MC_STATE_NOP,
    MC_INTERNAL_OPAMP_APP_MC_STATE_STOP,
} MC_INTERNAL_OPAMP_APP_MC_STATES;
...
{
	/* Application's state machine's initial state. */
	MC_INTERNAL_OPAMP_APP_STATE_INIT=0,
	MC_INTERNAL_OPAMP_APP_STATE_SERVICE_TASKS,

	/* TODO: Define states used by the application state machine. */


} MC_INTERNAL_OPAMP_APP_STATES;
...
typedef struct
{
    ...
    MC_INTERNAL_OPAMP_APP_STATES state;

    /* TODO: Define any additional data used by the application. */
	MC_INTERNAL_OPAMP_APP_CLASSB_STATES classBState;
	MC_INTERNAL_OPAMP_APP_MC_STATES mcState;

} MC_INTERNAL_OPAMP_APP_DATA;
...
/*******************************************************************************
  ...
  Example:
    <code>
    MC_INTERNAL_OPAMP_APP_Initialize();
    </code>
...
void MC_INTERNAL_OPAMP_APP_MC_CalcRefVec(void);
...
/* MC Debug Routines */
void MC_INTERNAL_OPAMP_APP_MC_DBG_Init(void);
void MC_INTERNAL_OPAMP_APP_MC_DBG_SyncComm(void);
void MC_INTERNAL_OPAMP_APP_MC_DBG_SnapUpdate(void);
void MC_INTERNAL_OPAMP_APP_MC_DBG_IDLECounter(void);
...
#endif /* _MC_INTERNAL_OPAMP_APP_H */
